...
@Component({
  selector: 'app-snake-zero-wall',
  imports: [CommonModule],
  templateUrl: './snake-zero-wall.html',
  styleUrl: './snake-zero-wall.css'
})

export class SnakeZeroWall {
  ...
  //daca a iesit, il mutam pe partea opusa a grid ului
  checkBorder() {
    const last = this.snake[this.snake.length - 1]; //obtinem pozitia capului sarpelui
