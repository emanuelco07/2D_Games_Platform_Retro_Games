...
@Component({
  selector: 'app-brickbreaker1',
  imports: [CommonModule],
  templateUrl: './brickbreaker1.html',
  styleUrl: './brickbreaker1.css'
})

export class Brickbreaker1 {
  ...
  time = 400; //folosita pentru a seta timpul intervalului
